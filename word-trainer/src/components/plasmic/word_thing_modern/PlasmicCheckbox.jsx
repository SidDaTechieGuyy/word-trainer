...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 9oXDvTszog3Q/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: yYwEEiXhAqfp/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: mP3G5UgH55Hg/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames("all", sty.svg__pnxvy)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames("all", sty.svg__yp0AN)}
            role={"img"}
          />
        ) : null}
      </div>

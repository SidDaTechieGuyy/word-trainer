...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: Ht2V-dblfiHr/css
...
function PlasmicMenuItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__flKuY)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames("all", sty.freeBox__u3XSd)}>
            <div className={classNames("all", "__wab_text", sty.text__wbpt1)}>
              <React.Fragment>
                {(() => {
                  try {
                    return $props.label;
        ...
        {(() => {
          ...
          <BaseText2
            ...
            slot={"description"}
          >
            <div className={classNames("all", "__wab_text", sty.text__abCo)}>

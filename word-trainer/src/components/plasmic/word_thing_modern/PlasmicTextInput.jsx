...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: zE82IbZw6xPp/css
                      ...
                      if (!isAnswered) {
                        $state.results = [
                          ...$state.results,
                          {
                            ...
                            word: $state.words[$state.currentIndex].question,
                            typed: $state.textBox,
                            correct:
                              $state.textBox.trim().toLowerCase() ===
                              $state.words[
                                $state.currentIndex
                              ].answer.toLowerCase()
                          }

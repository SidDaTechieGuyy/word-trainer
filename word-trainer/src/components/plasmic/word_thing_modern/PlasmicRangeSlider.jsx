...
import SliderThumb from "../../SliderThumb"; // plasmic-import: fGJE8RrvHZTi/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: HUcaaT6gEOrp/css
...
function PlasmicRangeSlider__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox___0LCwA)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames("all", "__wab_text", sty.text__oJei3)}
                >
                  {"Label"}
                </div>
              ),
      ...
      <div className={classNames("all", sty.freeBox__kW8Ne)}>
        <div

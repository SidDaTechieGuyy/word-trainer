...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: Z-oziunFKi1s/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames("all", sty.freeBox__klKtv)}>
        <div className={classNames("all", sty.freeBox__q6YCx)} />
      </div>
      {renderPlasmicSlot({

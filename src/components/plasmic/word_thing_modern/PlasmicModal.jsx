...
import sty from "./PlasmicModal.module.css"; // plasmic-import: egodYfsYhFTC/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_9N6YhFH1Rl2G"]]: true })}
        ...
        >
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div className={classNames("all", sty.freeBox__ezegp)}>
                    <div
                      className={classNames(
                        "all",
                        "__wab_text",
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__iljWt)}>
                  <Button
                    color={"muted"}
                    label={
                      <div

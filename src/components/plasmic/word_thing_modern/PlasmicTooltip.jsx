...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: RyezCFNLZFDT/css
...
function PlasmicTooltip__RenderFunc(props) {
  ...
  return (
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <div
                    className={classNames("all", "__wab_text", sty.text__gENL)}
                  >
                    {"Hello from Tooltip! "}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__mLbwO)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text___4Ir4Y)}>
            {"Hover me!"}
          </div>
        ),

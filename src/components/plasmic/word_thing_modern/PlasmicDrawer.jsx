...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: CzVRaCaxuIhI/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_LTmd-ceewcqU"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames("all", sty.freeBox__nyo3J)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__jbMy)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
              ...
              <div className={classNames("all", sty.freeBox__cj8Go)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__r9Uq)}>
                      <Button
                        color={"muted"}
                        label={"Close"}
                        onClick={async event => {
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__yFa25)}
                  label={
                    <div
                      className={classNames(
                        "all",

...
import Button from "../../Button"; // plasmic-import: bxadC0WTqrmZ/component
import { BasePopover } from "@plasmicpkgs/react-aria/skinny/registerPopover";
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: SWqBiOkL03Jb/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: d4SDov1rkIwl/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox___0Gf1P)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__fnTh8)}
                  >
                    {"This is a Popover!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__m08Xf)}
                  >
                    {"You can put anything here!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text___63GD)}
                  >
                    {
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__mIQo)}
            label={"Open Popover"}
          />
        ),

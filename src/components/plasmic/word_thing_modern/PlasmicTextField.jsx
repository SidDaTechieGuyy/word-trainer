...
import TextInput from "../../TextInput"; // plasmic-import: zE82IbZw6xPp/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: oFfYyxBj7i60/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: UozEY8P_dFlz/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox___0LtKk, {
          [sty.freeBoxiconEnd___0LtKkMKreg]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___0LtKkSRtDu]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___0LtKkXNfIl]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__uiyNb, {
            [sty.freeBoxiconStart__uiyNbSRtDu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__uiyNbXNfIl]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg___6W0Qv)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__oUqNq, {
            [sty.freeBoxiconEnd__oUqNqMKreg]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__oUqNqSRtDu]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__iisV8)}
                role={"img"}
              />
            ),
